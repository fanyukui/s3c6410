...
#define PART_ZIMAGE_OFFSET	0x80000
...
//#define MOVI_ENV_BLKCNT     ( CONFIG_ENV_SIZE / MOVI_BLKSIZE)
#define MOVI_ENV_POS        ( CONFIG_ENV_OFFSET / MOVI_BLKSIZE )
#define MOVI_1M_POS         ( 0x100000 / MOVI_BLKSIZE)
#define MOVI_BL2_BLKCNT		(((PART_ZIMAGE_OFFSET - PART_UBOOT_OFFSET) / MOVI_BLKSIZE))
#define MOVI_ZIMAGE_BLKCNT	((PART_ROOTFS_OFFSET - PART_ZIMAGE_OFFSET) / MOVI_BLKSIZE)
#define MOVI_BL2_POS		(MOVI_LAST_BLKPOS - MOVI_BL1_BLKCNT - MOVI_1M_POS)
